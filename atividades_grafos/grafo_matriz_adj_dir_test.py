...
class TestGrafo(unittest.TestCase):
    ...
    def test_dijkstra(self):
        ...
        self.assertEqual(self.grafoTeste.dijkstra("X", "N"), [])
        self.assertEqual(self.grafoTeste.dijkstra("K", "M"), ['K', 'L', 'M'])
        self.assertEqual(self.grafo.dijkstra("A", "E"), ['A', 'B', 'D', 'E'])
        self.assertEqual(self.g_p.dijkstra("J", "Z"), [])
        self.assertEqual(self.g_p.dijkstra("J", "C"), ['J', 'C'])
        self.assertEqual(self.g_p.dijkstra("J", "E"), ['J', 'C', 'E'])
        self.assertEqual(self.g_p.dijkstra("J", "T"), [])
