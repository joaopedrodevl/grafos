...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.grafoTeste2 = MeuGrafo()
        self.grafoTeste2.adiciona_vertice('A')
        self.grafoTeste2.adiciona_vertice('B')
        self.grafoTeste2.adiciona_vertice('C')
        self.grafoTeste2.adiciona_vertice('D')
        self.grafoTeste2.adiciona_vertice('E')
        self.grafoTeste2.adiciona_vertice('F')
        self.grafoTeste2.adiciona_aresta('ab', 'A', 'B', 9)
        self.grafoTeste2.adiciona_aresta('ac', 'A', 'C', 7)
        self.grafoTeste2.adiciona_aresta('cd', 'C', 'D', 2)
        self.grafoTeste2.adiciona_aresta('de', 'D', 'E', 2)
        self.grafoTeste2.adiciona_aresta('be', 'B', 'E', 2)
        self.grafoTeste2.adiciona_aresta('db', 'D', 'B', -3)
        self.grafoTeste2.adiciona_aresta('ef', 'E', 'F', -2)
        self.grafoTeste2.adiciona_aresta('fb', 'F', 'B', 2)
        
        self.grafoTeste3 = MeuGrafo()
        self.grafoTeste3.adiciona_vertice('A')
        self.grafoTeste3.adiciona_vertice('B')
        self.grafoTeste3.adiciona_vertice('C')
        self.grafoTeste3.adiciona_vertice('D')
        self.grafoTeste3.adiciona_vertice('E')
        self.grafoTeste3.adiciona_vertice('F')
        self.grafoTeste3.adiciona_aresta('ab', 'A', 'B', -1)
        self.grafoTeste3.adiciona_aresta('ac', 'A', 'C', -4)
        self.grafoTeste3.adiciona_aresta('cd', 'C', 'D', -5)
        self.grafoTeste3.adiciona_aresta('de', 'D', 'E', -2)
        self.grafoTeste3.adiciona_aresta('be', 'B', 'E', -7)
        self.grafoTeste3.adiciona_aresta('db', 'D', 'B', -3)
        self.grafoTeste3.adiciona_aresta('ef', 'E', 'F', 2)
        self.grafoTeste3.adiciona_aresta('fb', 'F', 'B', 1)
    ...
    def test_bellman_ford(self):
        self.assertEqual(self.grafoTeste2.bellman_ford("A", "F"), ['A', 'C', 'D', 'B', 'E', 'F'])
        self.assertEqual(self.grafoTeste2.bellman_ford("C", "B"), ['C', 'D', 'B'])
        self.assertEqual(self.grafoTeste2.bellman_ford("A", "B"), ['A', 'C', 'D', 'B']) 
        self.assertEqual(self.grafoTeste2.bellman_ford("A", "A"), ['A'])
        with self.assertRaises(VerticeInvalidoError):
            self.grafoTeste2.bellman_ford('A', 'Z')
        self.assertEqual(self.grafoTeste.bellman_ford("X", "Y"), ['X', 'Y'])
        self.assertEqual(self.grafoTeste.bellman_ford("M", "L"), "Nenhum caminho encontrado entre os vértices: M e L!")
        self.assertEqual(self.grafoTeste.bellman_ford("X", "L"), ['X', 'Y', 'L'])
        self.assertEqual(self.grafoTeste.bellman_ford("X", "Z"), ['X', 'Y', 'K', 'Z'])
        self.assertFalse(self.grafoTeste3.bellman_ford("A", "B"))
        self.assertFalse(self.grafoTeste3.bellman_ford("A", "C"))
        self.assertFalse(self.grafoTeste3.bellman_ford("A", "D"))
        self.assertEqual(self.g_p.bellman_ford("J", "Z"), "Nenhum caminho encontrado entre os vértices: J e Z!")
        self.assertEqual(self.g_p.bellman_ford("J", "C"), ['J', 'C'])
        self.assertEqual(self.g_c.bellman_ford("J", "C"), ['J', 'C'])
        self.assertEqual(self.g_l1.bellman_ford("A", "B"), ['A', 'B'])